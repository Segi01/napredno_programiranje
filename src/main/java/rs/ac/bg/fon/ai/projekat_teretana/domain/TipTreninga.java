...
/**
 * Predstavlja klasu TipTreninga koja nasleđuje apstraktnu klasu AbstractDomainObject za rad sa bazom podataka.
 * Klasa sadrži atribute kao što su id tipa treninga, naziv tipa treninga i opis tipa treninga.
 * 
 * @author Stefan Segrt
 */
public class TipTreninga extends AbstractDomainObject {
     ...
     * @return true - ako oba objekta imaju istu memorijsku lokaciju, ili ako imaju isti naziv tipa treninga.
     * false - u ostalim slučajevima
     */
    @Override
     ...
     * @throws SQLException ako dođe do greške prilikom čitanja podataka iz ResultSet-a.
     */
    @Override
