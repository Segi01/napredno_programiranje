...
/**
 * Predstavlja klasu Grad koja nasledjuje apstraktnu AbstractDomainObject za rad sa bazom podataka.
 * Klasa sadrzi atribut id i naziv grada.
 * 
 * @autor Stefan Segrt
 */
public class Grad extends AbstractDomainObject {
     ...
     * iste klase i imaju istu naziva
