...
public class RezultatiKorisnika extends AbstractDomainObject {
    ...
    /**
     * Statistika samog rezultata,u kojoj se nalaze procenat masti,misica i sama tezina korisnika
     */
     ...
     *
     * @return Objekat statistike u kome se nalazi procenat masti,misica i tezina korisnika.
     */
     ...
     *
     * @param statistika Objekat statistike koji se postavlja koji sadrzi procenat masti,misica i tezinu korisnika.
     ...
     * iste klase i imaju istog korisnika i datum rezultata. 
